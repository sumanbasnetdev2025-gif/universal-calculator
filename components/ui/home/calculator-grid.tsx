...
const tools = [
  {
    ...
    description: "AD ↔ BS conversion, age calculator, date differences",
    href: "/date-converter",
    icon: Calendar,
  ...
  },
  {
    ...
    description: "Hourly to salary, tax calculator, net pay",
    href: "/salary-payroll",
    icon: Briefcase,
  ...
  {
    title: "Fuel Cost",
    description: "Calculate fuel costs for any journey",
    href: "/fuel-cost",
    icon: Fuel,
